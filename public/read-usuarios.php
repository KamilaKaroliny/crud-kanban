...
<body>
<nav class="navbar navbar-expand-lg" style="background-color:rgb(179, 0, 98);">
...
<div class="container mt-4">
    ...
    <form method="post" class="row g-3">
        ...
        <div class="col-12">
            <button class="btn" style="background-color:rgb(179, 0, 98); color: white;">Cadastrar Tarefa</button>
        </div>
    </form>
</div>
</body>
